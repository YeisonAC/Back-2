#!/usr/bin/env python3
"""
Script de prueba para el servicio de geolocalización simplificado
"""
...
from geolocation_simple import simple_geolocation_service

def test_geolocation():
    """Prueba el servicio de geolocalización con diferentes IPs"""
    
    print("=== Prueba de Geolocalización Simplificada ===\n")
    ...
    for ip in test_ips:
        ...
        try:
            result = simple_geolocation_service.get_country_from_ip(ip)
...
if __name__ == "__main__":
    print("Iniciando pruebas de geolocalización simplificada...\n")
